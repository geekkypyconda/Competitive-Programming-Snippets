...
public class Solution {
    ...
    static Helper sc = new Helper(br,out);
    static int MOD = 1000000007,INF = Integer.MAX_VALUE,SEM_INF = INF / 2,NEG_INF = Integer.MIN_VALUE,SEM_NEG_INF = - SEM_INF;
    static long MAX_INF = Long.MAX_VALUE;
    //BigInteger B = new BigInteger("1");
    static int cas = 1,count = 0;
...
class Helper
{
    ...
    public Helper(BufferedReader br,BufferedWriter out)
    {
        try{
    ...
    public void writeGoogleOutput(Object o,int c) throws Exception
    {
        out.write("Case #" + c + ": " + String.valueOf(o));
    }

    public void writeGoogleOutputln(Object o,int c) throws Exception
    {
        out.write("Case #" + c + ": " + String.valueOf(o) + "\n");
    }
